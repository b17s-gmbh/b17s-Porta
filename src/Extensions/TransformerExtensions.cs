...
/// X-Forwarded-*) are stripped before the request is sent. Symmetrically, sensitive backend
/// response headers (Set-Cookie, Strict-Transport-Security, Content-Security-Policy, Server,
/// X-Powered-By) are stripped on the way back to the client unless added to
/// <see cref="AllowedResponseHeaders"/>.
/// </summary>
